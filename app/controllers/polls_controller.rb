class PollsController < ApplicationController
  ...
  private
    ...
    def poll_params
      params.require(:poll).permit(:poll_feedback,:poll_name, :poll_description, :poll_start_date, :poll_finish_date , questions_attributes: [:id, :question_header,:question_description, :_destroy],poll_images_attributes: [:id, :image, :_destroy])
    end
end
